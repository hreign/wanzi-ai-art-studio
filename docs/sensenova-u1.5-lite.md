# SenseNova **U1.5 Lite** 模型文档

## 基本信息

| 项目 | 内容 |
|------|------|
| **模型名称** | SenseNova **U1.5 Lite** |
| **Model ID** | `sensenova-u1.5-lite` |
| **模型描述** | 日日新最新一代图片创作模型，基于 Neo-unify 架构，生成与编辑一体，支持参考图功能及灵活修改。统一图像理解、生成与编辑链路，支持图片从创作到修改的完整流程；强化参考图创作与整体视觉表现，提升构图、光影、材质与细节的呈现；增强复杂指令遵循与多重约束执行能力。 |
...
| 参数 | 类型 | 必填 | 默认值 | 说明 |
|------|------|------|--------|------|
| **model** | `string` | 是 | — | 必须填 `sensenova-u1.5-lite`。 |
